...
class OrderStateTest {
    ...
    @Test
    @DisplayName("Ödemesi olmayan sipariş onaylanamaz")
    void givenUnpaidOrder_whenApprove_thenThrowsIllegalStateException() {
        IllegalStateException ex = assertThrows(IllegalStateException.class, () -> order.approve());
        assertEquals("Ödemesi tamamlanmamış sipariş onaylanamaz!", ex.getMessage());
    }
