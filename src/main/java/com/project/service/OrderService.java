...
public class OrderService {
    ...
    public void approveOrder(String orderId) {
        ...
        if (order.getItems().isEmpty()) {
            throw new IllegalStateException(
                "Ürün içermeyen sipariş onaylanamaz! Sipariş: " + orderId);
        }
        order.approve();
        orderRepository.save(order);
    ...
    public void startPreparing(String orderId) {
        ...
        orderRepository.save(order);
        log.info("Sipariş hazırlanıyor | {}", orderId);
    }
    ...
    public void shipOrder(String orderId, String trackingNumber, double shippingCost) {
        ...
        order.ship();
        orderRepository.save(order);
        log.info("Kargoya verildi | Sipariş: {} | Takip: {} | Ücret: {} TL",
    ...
    public void deliverOrder(String orderId) {
        ...
        order.deliver();
        orderRepository.save(order);
        log.info("Teslim edildi | {}", orderId);
    }
    ...
    public void returnOrder(String orderId) {
        ...
        order.returnOrder();
        orderRepository.save(order);
        log.info("İade başlatıldı | {}", orderId);
    }
