...
import com.project.domain.notification.StockObserver; // Gözlemci arayüzü

/**
 * Basit ürün - Composite Pattern'in yaprak (Leaf) düğümü.
 *
 * <p>Alt bileşenleri olmayan atomik ürünleri temsil eder.
...
public class SimpleProduct extends Product {
    ...
    // Observer Pattern: Gözlemcileri tutan liste.
    // @Transient: JPA'nın bu listeyi veritabanında sütun olarak oluşturmasını engeller.
    @Transient
