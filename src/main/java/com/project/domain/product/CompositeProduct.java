...
public class CompositeProduct extends Product {
    ...
    private static final Logger log = LoggerFactory.getLogger(CompositeProduct.class);
    ...
    public void display(String indent) {
        log.info("{}[Bileşik Ürün] {} | Montaj: {} TL | Toplam: {} TL | Stok: {}",
            indent, name, assemblyFee, getUnitPrice(), stock);
        log.info("{}  └─ Bileşenler:", indent);
    ...
    public static class Builder {
        ...
        public Builder assemblyFee(double fee) {
            if (fee < 0) {
                throw new IllegalArgumentException(
                    "Montaj ücreti negatif olamaz! Girilen: " + fee);
            }
        ...
        public CompositeProduct build() {
            ...
            if (stockThreshold < 0 || stockThreshold >= initialStock) {
                throw new IllegalArgumentException(
                    "Stok eşiği 0'dan küçük veya başlangıç stoğundan büyük/eşit olamaz.");
            }
